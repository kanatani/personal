...
<body>
    <?php 
        switch (true) {
            case $sum >= 13.6;
               $msg = 'キリストタイプ';
               $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_1586081839.jpg";
                $ssg = '他人を愛してやまない';
               $detail1 = '利他性の鏡';
            ...
            case $sum >= 4.9 && $sum <= 13.5;
                 $msg = 'ボランティアタイプ';
		 $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_1692488656.jpg";
                 $ssg = '第一印象から良い';
                $detail1 = 'チームワーク';
            ...
            case $sum >= -4.8 && $sum <= 4.8;
                $msg = 'バランスタイプ';
                $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_478518385.jpg";
                $ssg = '共感と客観を兼ね備えた';
               $detail1 = '合理性を重視する';
               ...
               $boxdetail6='競争が激しい環境では、その独自性を発揮して行動することができるため、成果を出しやすくなります。自分がストイックになれる環境を選んで見るのもいい選択になりえます。';
                ...
                $msg = '客観性重視タイプ';
                $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_603829727.jpg";
                $ssg = '合理的な答えを見つけやすい';
               $detail1 = '合理性を重視する';
            ...
            case $sum <= -13.6;
                $msg = '独自性タイプ';
                $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_1080828530.jpg";
                $ssg = '一人で物事を遂行する';
               $detail1 = 'カリスマ性や独自性';
