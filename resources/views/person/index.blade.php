          ...
          <div class="top_intro col-sm-12 data-delighter">
            ...
            <div class="boxes">
              ...
              <h3>性格診断</h3>
                ...
                <p>big5からなる性格診断で5つの観点から性格をみることができます。心理学に基づいた研究で、知らない自分の一面を知ることができます。</p>
              </div>
              <div class="box">
                <h3>相手の性格診断</h3>
                <i class="fas fa-user-circle"></i>
                <p>気になっている相手の性格をみて分析してみよう。相手の性格を見ることで、相手のことをより詳しく理解できるでしょう。</p>
              </div>
              <div class="box">
              <h3>コストがかからない</h3>
              <i class="fas fa-male"></i>
              <p>personの基本機能は無料です。なので、何度も診断することができます。人間関係を充実させる一つのツールとしてどんどん使用してください。</p>
            </div>
          </div>
        </div>
        </div>
