...
<body>
    <?php 
        switch (true) {
            case $sum >= 13.6;
               $msg = 'ナポレオンタイプ';
               $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_205554184.jpg";
                $ssg = '新しいことが大好きな';
               $detail1 = '変化が大好き';
            ...
            case $sum >= 4.9 && $sum <= 13.5;
                 $msg = '冒険家タイプ';
                 $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_443840548.jpg";
                 $ssg = '幅広い興味がある';
                $detail1 = '着実に取り組む';
            ...
            case $sum >= -4.8 && $sum <= 4.8;
                $msg = '器用タイプ';
                $img ="http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_670192495.jpg";
                $ssg = 'ルールと刺激をコントロールする';
               $detail1 = '世渡り上手';
               ...
               $boxmain1 ='幅広い交友関係';
                ...
                $msg = '慎重タイプ';
                $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_1767680240.jpg";
                $ssg = 'ルールで安全策を練る';
               $detail1 = '慎重に着実に';
            ...
            case $sum <= -13.6;
                $msg = 'マイペースタイプ';
                $img = "http://d1lndi27iqd683.cloudfront.net/personimage/shutterstock_198973802.jpg";
                $ssg = '慣れ親しんだ物が大好きな';
               $detail1 = 'マイペース';
