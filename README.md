...
## アプリ開発のきっかけ
 - 1.心理学の知識を活かしたアプリを作成したかったから。
 - 2.お客様の日常に直接良い影響を与えれるようなサービス開発を目指しているから。


## アプリ開発の概要
Personは、性格分析を行うことで、各ユーザーのニーズに合ったマッチングアプリを作成することができます。友人が欲しい人は協調性が高い人を選ぶという基準があり、仕事仲間では真面目さを測っている性格を見て選ぶということができます。このように心理分析を行うことで、各ユーザーの要望に合った使い方ができるマッチングアプリを作りました。
<br>
...
-  要件定義
-  設計(基本設計/詳細設計)
-  他人が見やすいコードをもっと意識 (コメントアウト、わかりやすい変数名)
-  テストに関する知識
-  dockerを本番環境に導入
-  チーム開発を意識するため、branchを切ってプルリクをしてマージする機会を増やす
-  自分の興味分野でのアプリ作成をもっと経験する(好奇心)

## 質問紙テストの参考文献
-  小塩真司 パーソナリティ心理学 ミネルブァ書房 2019 p82~P114
-  串崎真志 絶対役立つ臨床心理学 ミネルブァ書房 2017 p17~P31
